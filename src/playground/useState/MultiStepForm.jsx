...
// TODO: Create a multi step form where a user can step through and return to previous step. Update the form data as user progressed through the form and when finished submit the form and reset the component's state
...
const MultiStepForm = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // not going to do anything with the formData just practicing state management
